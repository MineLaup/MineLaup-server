...
export default class ModsController {
  ...
  /**
   * Change mod state from modpack version function
   */
  public async modState ({ params, request, response, auth }: HttpContextContract) {
    // Validate datas
    const data = await request.validate({
      schema: schema.create({
        v: schema.number([
  ...
  /**
   * Mod information from modpack version function
   */
  public async getMod ({ request, params, auth, response }: HttpContextContract) {
    // Validate datas
    const data = await request.validate({
      schema: schema.create({
        v: schema.number([
