<template>
  ...
  >
    ...
    <span
      v-if="showTitle"
      class="absolute bg-gray-800 px-1 rounded top-0 left-0 mt-10 sm:mt-2 sm:ml-12 z-20 whitespace-no-wrap select-none"
    >
      {{ name }}
    </span>
  </li>
...
@Component
export default class TSideBarAction extends Vue {
  @Prop({ required: true })
  name!: string
